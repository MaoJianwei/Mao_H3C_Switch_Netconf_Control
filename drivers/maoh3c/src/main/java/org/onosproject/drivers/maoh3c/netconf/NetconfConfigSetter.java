...
package org.onosproject.drivers.maoh3c.netconf;
...
public class NetconfConfigSetter extends AbstractHandlerBehaviour
    ...
    private static final String PUSH_XML_FAIL =
            "Mao: Fail to push XML\n";

    private static final String SUFFIX = "]]>]]>";

    @Override
    public String setConfiguration(String requestXML) {
        DriverHandler handler = handler();
        NetconfController controller = handler.get(NetconfController.class);
        DeviceId deviceId = handler.data().deviceId();
        Preconditions.checkNotNull(controller, "Mao Netconf controller is null");

        String request = requestXML + SUFFIX;
        ...
        return PUSH_XML_FAIL + requestXML;
    }
}
